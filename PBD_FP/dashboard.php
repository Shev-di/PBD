    ...
    if ($resultBarang->num_rows > 0) {
        ...
        if ($stok >= $jumlah) {
            ...
            if ($conn->query($queryNota) === TRUE) {
                ...
                echo "Gagal menambahkan ke nota: " . $conn->error;
            }
        } else {
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    $subtotal = $row['harga'] * $row['quantity']; // Hitung subtotal
                                    $totalKeseluruhan += $subtotal; // Tambahkan ke total keseluruhan
                                ...
                                echo "<td>" . number_format($totalKeseluruhan, 0, ',', '.') . "</td>";
                                echo "</tr>";
                            } else {
